...
import { MainContainer, Part1 } from "./PortifolioStyle";
        ...
        <div className="down">
          <div className="dropup" onMouseEnter={hover} onMouseLeave={leave}>
            ...
            <div className="dropup-content">
              <a
                href="https://projeto-academia.vercel.app/"
                target="_blank"
                rel="noreferrer"
              >
                Preview
              ...
              <a
                href="https://github.com/brunosp-49/projeto-academia"
                target="_blank"
                rel="noreferrer"
              >
                GitHub
          ...
          <div className="dropup1" onMouseEnter={hover} onMouseLeave={leave}>
            ...
            <div className="dropup-content1">
              <a
                href="https://github.com/brunosp-49/coodesh-store-list"
                target="_blank"
                rel="noreferrer"
              >
                Preview
          ...
          <div className="dropup2" onMouseEnter={hover} onMouseLeave={leave}>
            ...
            <div className="dropup-content2">
              <a
                href="https://github-list09.herokuapp.com/"
                target="_blank"
                rel="noreferrer"
              >
                Preview
              ...
              <a
                href="https://github.com/brunosp-49/gitHub-list"
                target="_blank"
                rel="noreferrer"
              >
                GitHub
          ...
          <div className="more">
            <a
              href="https://github.com/brunosp-49?tab=repositories"
              target="_blank"
              rel="noreferrer"
            >
              <button>MORE</button>
